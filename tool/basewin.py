...
class MyFrame1(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        #sbSizer12.Add(gSizer8, 1, wx.EXPAND, 6)

        #fgSizer3.Add(sbSizer12, 1, wx.EXPAND, 6)

        sbSizer13 = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, u"关键词抽取"), wx.VERTICAL)

        gSizer12 = wx.GridSizer(12, 1, 0, 0)

        # todo *********************************************************************************************************************************
        self.address_radio = wx.RadioButton(self, wx.ID_ANY, u"原因中的核心名词(reason): ", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        # todo *********************************************************************************************************************************
        self.name_radio = wx.RadioButton(self, wx.ID_ANY, u"原因中的核心名词的谓语状态(reasonv): ", wx.DefaultPosition, wx.DefaultSize, 0)
        gSizer12.Add(self.name_radio, 0, wx.ALL, 5)
        self.name_words = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(710, -1),
                                      0 | wx.NO_BORDER)
        ...
        # todo *********************************************************************************************************************************
        self.keyword_radio = wx.RadioButton(self, wx.ID_ANY, u"中心词(key): ", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        # todo add 结果 *********************************************************************************************************************************
        self.result_radio = wx.RadioButton(self, wx.ID_ANY, u"结果中的核心名词(result): ", wx.DefaultPosition, wx.DefaultSize, 0)
        gSizer12.Add(self.result_radio, 0, wx.ALL, 5)

        self.result_words = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(710, -1),
                                     0 | wx.NO_BORDER)
        self.result_words.SetBackgroundColour(wx.SystemSettings.GetColour(wx.SYS_COLOUR_ACTIVECAPTION))
        gSizer12.Add(self.result_words,0,wx.ALL,5)


        # todo add 结果谓语状态 *********************************************************************************************************************************
        self.result_status_radio = wx.RadioButton(self, wx.ID_ANY, u"结果中核心名词的谓语状态(resultv): ", wx.DefaultPosition, wx.DefaultSize, 0)
        gSizer12.Add(self.result_status_radio, 0, wx.ALL, 5)

        self.result_status_words = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(710, -1),
                                     0 | wx.NO_BORDER)
        self.result_status_words.SetBackgroundColour(wx.SystemSettings.GetColour(wx.SYS_COLOUR_ACTIVECAPTION))
        gSizer12.Add(self.result_status_words,0,wx.ALL,5)


        sbSizer13.Add(gSizer12, 1, wx.EXPAND, 6)

        fgSizer3.Add(sbSizer13, 1, wx.EXPAND, 5)

        gSizer9 = wx.GridSizer(1, 2, 12, 0)
        ...
        self.m_button41 = wx.Button(self, wx.ID_ANY, u"增加因果对", wx.DefaultPosition, wx.Size(200, -1), 0)
        ...
        #.Bind(wx.EVT_BUTTON, self.reload)
        # todo add
        self.result_radio.Bind(wx.EVT_RADIOBUTTON,self.select_result)
        self.result_status_radio.Bind(wx.EVT_RADIOBUTTON,self.select_result_status)
    def __del__(self):
        pass

    def get_select_words(self, event):
        event.Skip()
